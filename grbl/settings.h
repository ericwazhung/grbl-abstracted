...
#include "grbl.h"
#include "cpu_map/port_handling.h" //Necessary for gpioPortWidth_t
...
gpioPortWidth_t get_step_pin_mask(uint8_t i);

// Returns the direction pin mask according to Grbl's internal axis numbering
gpioPortWidth_t get_direction_pin_mask(uint8_t i);

// Returns the limit pin mask according to Grbl's internal axis numbering
gpioPortWidth_t get_limit_pin_mask(uint8_t i);
